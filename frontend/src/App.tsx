...
const projects: Project[] = [
  {
    id: 1,
    name: "Sistema de Visitantes - Liberaê (Versão: Beta)",
    description: "Sistema está em fase de teste e novas funcionalidades estão sendo desenvolvidas.",
    progress: 100,
    nextUpdate: [
      "Atualizar filtro do relatório.",
      "Adicionar no cadastro de visitante [ Placa e Cor do veículo ]. ✅",
      "Adicionar na Triagem/Historico de visitantes [ Placa, Cor do veículo e Observação ]. ✅",
      "Adicionar Modal na Função de Liberar visita 'Nome de quem Liberou'. ✅",
    ],
    lastUpdate: "Sistema em produção com todas as funcionalidades básicas implementadas."
  },
  {
    id: 2,
    ...
    nextUpdate: [
      "Versão BETA",
      "Bipagem de cracha de colaboradores",
      "Cadastro de visitantes",
      "Sistema de ticket para Gestão",
  ...
  },
  {
    id: 3,
    name: "DimeX",
    description: "O DimeX é um sistema onde vai ser implementado demasiados processos e funcionalidades da Dime.",
    progress: 100,
    nextUpdate: [""],
    lastUpdate: ""
  },
...
function App() {
  ...
  const toggleCardExpansion = (projectId: number) => { // Parâmetro tipado
              ...
              <div className="project-header">
                <div className="project-title-row">
                  ...
                  <button
                    ...
                    >
                      {expandedCard === project.id ? 'Menos detalhes' : 'Mais detalhes'}
                  </button>
                </div>
                ...
                {expandedCard === project.id && (
                  <div className="project-details">
                      <div className="detail-section">
                          ...
                          <ul>
                              {project.nextUpdate.map((update, index) => (
